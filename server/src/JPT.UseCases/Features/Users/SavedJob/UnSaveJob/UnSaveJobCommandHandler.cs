...
internal sealed class UnSaveJobCommandHandler(
    IApplicationDbContext dbContext,
    IUnitOfWork unitOfWork,
    IUserProvider userProvider,
    IUserRepository userRepository) : IRequestHandler<UnSaveJobCommand, Result<Guid>>
{
    public async Task<Result<Guid>> Handle(UnSaveJobCommand command, CancellationToken cancellationToken)
    {
        ...
        var result = user.UnSaveJob(command.JobId);
